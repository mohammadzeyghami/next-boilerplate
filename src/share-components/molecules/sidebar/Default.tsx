...
import { useIsMobile } from "@/share-components/hooks/useIsMobile";
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
          "group/sidebar-wrapper flex flex-1 min-h-svh  has-data-[variant=inset]:bg-sidebar min-w-screen max-w-screen",
          className,
        )}
        {...props}
      >
